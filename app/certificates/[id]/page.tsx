...
import { DiplomaIcon } from '../../components/Icons';
    ...
    <div className="min-h-screen bg-[#FFF3EB]">
      ...
      <div className="lg:mr-70 xl:mr-70 md:mr-0">
        ...
        <div className="p-3 sm:p-6">
          ...
          <div className="w-full rounded-2xl overflow-hidden" style={{ borderRadius: '16px', padding: '5px', background: 'linear-gradient(109.45deg, #FF6400 0.67%, #F59F00 99.65%)' }}>
            <div className="w-full bg-white rounded-xl" style={{ padding: '40px 24px' }}>
              <div className="flex flex-col items-center gap-8">
                <div className="w-30 h-30 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(180deg, #FF6400 0%, #F5A00F 100%)', padding: '12px' }}>
                ...
                <div className="text-center">
                  ...
                  <div className="w-45 h-1 rounded-[20px] mx-auto mt-3" style={{ background: 'linear-gradient(90deg, #FF6400 0%, #F59F00 100%)' }}></div>
                </div>
                ...
                <div className="flex flex-wrap justify-center gap-4 w-full max-w-3xl">
                  <div className="flex-1 min-w-35 h-22.5 rounded-lg bg-[#FFF3EB] flex flex-col items-center justify-center gap-1 p-3" style={{ boxShadow: '0px 2px 2px 0px rgba(0, 0, 0, 0.25)' }}>
                  ...
                  <div className="flex-1 min-w-35 h-22.5 rounded-lg bg-[#FFF3EB] flex flex-col items-center justify-center gap-1 pr-12 pl-12" style={{ boxShadow: '0px 2px 2px 0px rgba(0, 0, 0, 0.25)' }}>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="flex-1 min-w-35 h-22.5 rounded-lg bg-[#FFF3EB] flex flex-col items-center justify-center gap-1 p-3" style={{ boxShadow: '0px 2px 2px 0px rgba(0, 0, 0, 0.25)' }}>
                    ...
                    <p className="font-cairo font-bold text-xs text-[#FF6400]">{certificateData.status}</p>
                  </div>

                <div className="flex flex-wrap justify-center gap-8 sm:gap-16 mt-2">
                  <div className="flex flex-col items-center gap-2">
                    <div className="w-45 h-0.5 rounded-[20px]" style={{ background: 'rgba(255, 198, 161, 1)' }}></div>
                    <p className="font-cairo text-xs text-gray-500">إدارة المنصة</p>
                    <p className="font-cairo font-bold text-sm text-[#113555]">التوقيع</p>
                  </div>
                  <div className="flex flex-col items-center gap-2">
                    <div className="w-45 h-0.5 rounded-[20px]" style={{ background: 'rgba(255, 198, 161, 1)' }}></div>
                    <p className="font-cairo text-xs text-gray-500">المدرب</p>
                    <p className="font-cairo font-bold text-sm text-[#113555]">{certificateData.instructor}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            <button onClick={handleDownload} className="flex items-center gap-2 py-3 px-6 rounded-lg font-cairo font-semibold text-sm bg-[#FF6400] text-white hover:bg-[#E55A00] transition-colors">
              <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.833 13V15.5H4.167V13" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M10 3.5V11.5L12.5 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              تحميل الشهادة
            </button>
