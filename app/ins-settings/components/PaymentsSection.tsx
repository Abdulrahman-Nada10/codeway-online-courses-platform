  ...
  return (
    <div className="space-y-8">
      <div className="text-right pb-4">
        ...
        <p className="font-cairo text-sm text-gray-500 mt-1">إعدادات حسابك البنكي لاستلام الأرباح</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-[#FFF3EB] border border-[#FF6400]/20 rounded-xl p-4 text-right">
          <p className="font-cairo text-sm text-gray-700">
            <strong className="text-[#113555]">ملاحظة:</strong> يتم تحويل الأرباح في بداية كل شهر. نسبة عمولة المنصة 20%.
          </p>
        </div>
      </div>
