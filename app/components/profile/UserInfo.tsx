  ...
  return (
    <div className="bg-white rounded-2xl p-3 sm:p-5 shadow-sm border border-gray-200">
      <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4 lg:gap-6">
        {/* Avatar */}
        <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-full overflow-hidden border-4 border-[#FF6400] flex-shrink-0 mx-auto sm:mx-0">
          <Image
            src={avatar}
            alt="الصورة الشخصية"
            width={112}
        ...
        <div className="flex-1 w-full">
          ...
          {/* Info Grid */}
          <div className="flex flex-col sm:flex-row sm:flex-wrap gap-2 sm:gap-x-4 lg:gap-x-34 sm:gap-y-2">
            {/* Email */}
