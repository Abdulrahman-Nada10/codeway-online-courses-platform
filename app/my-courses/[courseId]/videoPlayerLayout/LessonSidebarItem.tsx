  ...
  if (status === 'available') {
    return (
      <div className="absolute left-1/2 top-1/2 flex h-7 w-7 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-[#FF6400] text-white shadow-[0_6px_12px_rgba(255,100,0,0.28)]">
        <Play className="mr-[-2px] h-3.5 w-3.5 fill-current" />
      </div>
    );
  }
...
export default function LessonSidebarItem({
  ...
  return (
    ...
    >
      ...
      <div className="relative h-[40px] overflow-hidden rounded-[4px] min-[360px]:h-[46px] sm:h-[50px] lg:h-[40px] xl:h-[42px]">
        ...
        <span className="absolute bottom-0.5 left-0.5 rounded bg-[#1F2937]/85 px-1 py-[1px] text-[7px] font-semibold text-white">
