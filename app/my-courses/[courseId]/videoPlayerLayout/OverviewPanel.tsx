...
export default function OverviewPanel({
  ...
  if (points.length === 0) {
    return (
      <div className="flex h-[164px] flex-col items-center justify-center rounded-[16px] border border-[#E8D8CA] bg-white text-[#8B8B8B] shadow-[0_10px_24px_rgba(17,53,85,0.06)]">
  ...
  return (
    <div className="h-[164px] overflow-hidden rounded-[16px] border border-[#E8D8CA] bg-white px-5 py-4 shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
      ...
      <div className="custom-scrollbar mt-2 h-[88px] overflow-y-auto text-right text-[11px] leading-5 text-[#4B5563]">
