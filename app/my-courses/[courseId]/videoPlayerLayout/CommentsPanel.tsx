...
export default function CommentsPanel({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-2">
      <div className="flex h-[62px] items-center gap-2 rounded-[16px] border border-[#E8D8CA] bg-white px-5 py-4 shadow-[0_8px_20px_rgba(17,53,85,0.05)]">
        <button
          type="button"
      ...
      <div className="relative h-[348px] overflow-hidden rounded-[16px] border border-[#E8D8CA] bg-white shadow-[0_8px_20px_rgba(17,53,85,0.06)] lg:h-[396px] xl:h-[432px]">
        <button
          type="button"
          onClick={onClose}
