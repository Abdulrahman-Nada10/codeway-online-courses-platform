...
export default function VideoPlayerLayout({ course }: { course: VideoPlayerCourse }) {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden overflow-y-auto bg-[#FFF3EB] pt-22 lg:h-screen lg:overflow-hidden lg:pt-26">
      <Sidebar />
      ...
      <div className="min-h-[calc(100vh-5.5rem)] md:mr-0 lg:h-[calc(100vh-6.5rem)] lg:min-h-0 lg:mr-24 xl:mr-28">
        ...
        <main className="h-full w-full overflow-visible p-2.5 sm:p-4 lg:overflow-hidden lg:px-5 lg:py-0 xl:px-6" dir="rtl">
          <div className="mx-auto flex h-full max-w-[1076px] flex-col gap-2 pt-4 lg:gap-2.5 lg:pt-6 xl:pt-7">
            <div className="flex w-full flex-col items-start gap-1 text-right xl:max-w-[702px]">
              <Link
                href="/my-courses"
            ...
            <div className="grid gap-3 lg:h-[calc(100%-3.75rem)] lg:gap-2 lg:grid-cols-[minmax(0,1fr)_300px] lg:justify-center xl:grid-cols-[minmax(0,702px)_358px] xl:items-start" dir="ltr">
              <section className="order-1 flex min-w-0 flex-col gap-2 lg:h-full xl:w-[702px] xl:-translate-x-14 xl:-translate-y-11">
                <div
              ...
              <div className="order-2 w-full lg:h-full lg:w-[300px] xl:w-[358px] lg:flex-shrink-0">
                <LessonSidebar
