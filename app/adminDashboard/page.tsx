...
const DashboardMain: React.FC = () => {
  ...
  return (
    <main className="flex-1 p-6 bg-[#F9F1E9] min-h-screen font-sans" dir={dir}>
      
   
      <div className="mb-8 bg-[#F9F1E9] text-start ">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <motion.div 
          ...
          className="lg:col-span-2 bg-white rounded-4xl p-6 shadow-sm border border-orange-50"
        >
        ...
        <div className="bg-white rounded-4xl p-6 shadow-sm border border-orange-50">
...
const StatCard: React.FC<StatCardProps> = ({ title, value, change, icon, isPositive = true }) => (
  <motion.div 
    ...
    className="bg-white p-5 rounded-3xl shadow-sm border border-orange-50 flex items-center justify-between"
  >
