...
export function SessionDetails({ session }: { session: LiveSession }) {
  return (
    <section className="rounded-2xl bg-white p-4 shadow-[0_10px_35px_rgba(17,53,85,0.06)] sm:p-5" dir="rtl">
      <div dir='ltr' className="flex flex-col gap-4 border-b border-[#f0e6df] pb-5 sm:pb-6 xl:flex-row xl:items-start xl:justify-between">
        ...
        <div className="text-right">
          <h1 className="text-xl font-semibold leading-[1.8] text-[#111827] sm:text-2xl xl:max-w-3xl xl:text-3xl">
            {session.title}
          </h1>
      ...
      <div className="grid gap-6 pt-5 lg:grid-cols-[minmax(0,1fr)_280px] lg:pt-6">
        <div className="text-right">
          <h2 className="text-lg font-semibold text-[#8c8c8c] sm:text-xl">عن هذه الجلسة</h2>
          <p className="mt-4 max-w-4xl text-sm leading-7 text-[#4b5563] sm:text-base sm:leading-8">{session.description}</p>
        ...
        <div className="space-y-3">
          <h2 className="text-right text-lg font-semibold text-[#8c8c8c] sm:text-xl">المصادر</h2>
