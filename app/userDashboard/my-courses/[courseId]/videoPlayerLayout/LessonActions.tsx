...
export default function LessonActions({
  ...
  return (
    <div className="flex flex-col gap-2 rounded-2xl border border-[#E8D8CA] bg-white px-3 py-3 shadow-[0_8px_20px_rgba(17,53,85,0.05)] sm:flex-row sm:items-center sm:justify-between sm:gap-3 sm:px-4" dir="rtl">
