...
export default function LessonSidebar({
  ...
  return (
    <aside className="w-full overflow-hidden rounded-2xl border border-[#E8D8CA] bg-white shadow-[0_10px_24px_rgba(17,53,85,0.06)] lg:w-75 xl:w-89.5 lg:self-start lg:shrink-0">
