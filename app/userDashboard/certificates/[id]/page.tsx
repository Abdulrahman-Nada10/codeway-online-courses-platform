      ...
      <div className="lg:mr-70 xl:mr-70 md:mr-0">
        <div className="p-3 sm:p-6">
          <div className="mb-6 flex items-center gap-3">
            <Link href="/userDashboard/certificates" className="w-8 h-8 rounded-lg bg-white flex items-center justify-center shadow-sm hover:shadow-md transition-shadow">
